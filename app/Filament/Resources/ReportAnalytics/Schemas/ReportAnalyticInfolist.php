...
namespace App\Filament\Resources\ReportAnalytics\Schemas;
    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema->components([
            Callout::make('Wajib Pajak Tanpa NPWP')
                ...
                ->warning()
                ->visible(fn (ReportAnalytic $record): bool => blank($record->npwp)),
            ...
            Callout::make('Nilai PPh21 Negatif')
                ...
                ->danger()
                ->visible(fn (ReportAnalytic $record): bool => (float) $record->pph21 < 0),
