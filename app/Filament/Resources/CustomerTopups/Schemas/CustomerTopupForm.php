...
namespace App\Filament\Resources\CustomerTopups\Schemas;
            ...
            Grid::make(12)
                ->schema([
                    ...
                    TextInput::make('amount')
                        ...
                        ->prefix('Rp')
                        ->placeholder('0')
                        ->helperText('Nominal topup yang masuk ke wallet customer.')
                        ->columnSpan([
                            'default' => 12,
                            'md' => 3,
                        ]),
                    ...
                    TextInput::make('payment_method')
                        ...
                        ->placeholder('Contoh: admin_inject, bank_transfer')
                        ->default('admin_inject')
                        ->maxLength(255)
                        ->columnSpan([
                            'default' => 12,
                            'md' => 4,
                    ...
                    TextInput::make('transaction_ref')
                        ...
                        ->placeholder('Contoh: TOPUP-20260101-001')
                        ->maxLength(255)
                        ->columnSpan([
                            'default' => 12,
                            'md' => 4,
