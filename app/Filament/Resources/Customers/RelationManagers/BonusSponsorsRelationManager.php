...
class BonusSponsorsRelationManager extends RelationManager
{
    protected static string $relationship = 'bonusSponsors';

    protected static ?string $title = 'Bonus Sponsor';
