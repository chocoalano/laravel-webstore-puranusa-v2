...
import { useToast as useToast$1 } from "@nuxt/ui/runtime/composables/useToast.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(footerGroups.value, (group) => {
        _push(`<div class="flex flex-col gap-4"><div class="relative"><h3 class="text-[11px] font-bold uppercase tracking-[0.2em] text-gray-900 dark:text-white"> Footer Main </h3><div class="mt-2 h-0.5 w-4 bg-primary-500 rounded-full"></div></div><ul class="flex flex-col gap-y-2.5"><!--[-->`);
            ...
            return [
              createVNode("span", { class: "flex items-center gap-2.5" }, [
                createVNode("div", { class: "grid size-9 place-items-center rounded-xl bg-gray-900 text-white dark:bg-white dark:text-gray-900 shadow-sm" }, [
                  createVNode("img", {
                    src: "/assets/logo-puranusa-light.webp",
                    class: "size-4.5 dark:hidden",
                    alt: "Puranusa logo"
                  }),
                  createVNode("img", {
                    src: "/assets/logo-puranusa.webp",
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="min-w-0 truncate"> Gratis ongkir untuk pesanan di atas <span class="font-medium text-white">Rp 499.000</span></span></div>`);
      if (utilityLinks.value.length) {
        _push(`<div class="hidden items-center divide-x divide-gray-700 sm:flex"><!--[-->`);
