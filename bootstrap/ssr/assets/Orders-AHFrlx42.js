                    ...
                    _push2(ssrRenderComponent(_component_UCard, {
                      ...
                      default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                        if (_push3) {
                          ...
                          if (props.normalizeImageUrl(item.image)) {
                            _push3(`<img${ssrRenderAttr("src", props.normalizeImageUrl(item.image) ?? void 0)}${ssrRenderAttr("alt", item.name)} class="h-full w-full object-cover" loading="lazy"${_scopeId2}>`);
                          } else {
                          ...
                          return [
                            createVNode("div", { class: "flex items-center gap-3" }, [
                              createVNode("div", { class: "size-10 shrink-0 overflow-hidden rounded-xl bg-elevated/40" }, [
                                props.normalizeImageUrl(item.image) ? (openBlock(), createBlock("img", {
                                  key: 0,
                                  src: props.normalizeImageUrl(item.image) ?? void 0,
                                  alt: item.name,
                  ...
                  if (_push3) {
                    ...
                    if (__props.detailItems.length) {
                      ...
                      ssrRenderList(__props.detailItems, (item) => {
                        ...
                        if (__props.normalizeImageUrl(item.image)) {
                          _push3(`<img${ssrRenderAttr("src", __props.normalizeImageUrl(item.image) ?? void 0)}${ssrRenderAttr("alt", item.name)} class="h-full w-full object-cover" loading="lazy"${_scopeId2}>`);
                        } else {
                          _push3(`<div class="flex h-full w-full items-center justify-center"${_scopeId2}>`);
                          _push3(ssrRenderComponent(_component_UIcon, {
                            name: "i-lucide-image",
                        ...
                        (openBlock(true), createBlock(Fragment, null, renderList(__props.detailItems, (item) => {
                          return openBlock(), createBlock("div", {
                            ...
                            createVNode("div", { class: "size-14 shrink-0 overflow-hidden rounded-lg bg-elevated/60" }, [
                              __props.normalizeImageUrl(item.image) ? (openBlock(), createBlock("img", {
                                key: 0,
                                src: __props.normalizeImageUrl(item.image) ?? void 0,
                                alt: item.name,
                                class: "h-full w-full object-cover",
                                loading: "lazy"
                              }, null, 8, ["src", "alt"])) : (openBlock(), createBlock("div", {
          ...
          if (_push2) {
            ...
            return [
              createVNode(_sfc_main$2, {
                ...
                onLoadMore: unref(loadMore),
                onReset: unref(reset)
              }, null, 8, ["loading", "all-orders", "filtered", "status-meta", "payment-meta", "is-loading-more", "has-more", "paying-order-id", "checking-payment-order-id", "format-date-time", "format-currency", "normalize-image-url", "is-order-unpaid", "can-pay-now", "onOpenDetail", "onPayNow", "onCheckPaymentStatus", "onLoadMore", "onReset"])
            ];
          }
        }),
        _: 1
