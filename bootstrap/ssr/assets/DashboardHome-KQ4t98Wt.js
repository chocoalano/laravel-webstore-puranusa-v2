      ...
      _push(ssrRenderComponent(_component_UCard, mergeProps({ class: "rounded-2xl" }, _attrs), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.networkProfile?.username) {
              _push2(ssrRenderComponent(_component_UButton, {
                color: "neutral",
                variant: "ghost",
                size: "xs",
                ...
                onClick: ($event) => unref(copyToClipboard)(__props.networkProfile?.username ?? "")
              }, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
              ...
              createVNode("div", { class: "grid grid-cols-2 gap-2" }, [
                ...
                createVNode("div", { class: "rounded-xl bg-gray-50 dark:bg-gray-900 px-3 py-2.5" }, [
                  ...
                  createVNode("div", { class: "mt-0.5 flex items-center gap-1.5" }, [
                    ...
                    __props.networkProfile?.username ? (openBlock(), createBlock(_component_UButton, {
                      key: 0,
                      color: "neutral",
                      variant: "ghost",
                      size: "xs",
