...
import { ref, computed, watch, defineComponent, mergeProps, withCtx, createTextVNode, useSSRContext, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, resolveComponent, createCommentVNode, onMounted, nextTick, unref } from "vue";
...
function useNetworkTree(binaryTree, networkTreeStats) {
  ...
  watch(
    ...
    (tree) => {
      ...
      collapsedIds.value = flattenTree(tree).map((member) => member.id).filter((id) => id !== tree.id);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UCard, { class: "w-40 max-w-[calc(100vw-3rem)] rounded-xl border border-default sm:w-60 sm:max-w-none sm:rounded-2xl lg:w-65" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-1 sm:space-y-2"${_scopeId}><div class="flex items-start justify-between gap-2"${_scopeId}><div class="min-w-0"${_scopeId}><p class="truncate text-xs font-semibold text-highlighted sm:text-sm"${_scopeId}>${ssrInterpolate(__props.node.name)}</p><p class="truncate text-[10px] text-muted sm:text-[11px]"${_scopeId}>@${ssrInterpolate(__props.node.username)}</p></div><div class="flex items-center gap-1"${_scopeId}>`);
            ...
            _push2(`</div></div><div class="flex flex-wrap gap-0.5 sm:gap-1"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UBadge, {
              color: "neutral",
              variant: "subtle",
              size: "xs",
            ...
            _push2(ssrRenderComponent(_component_UBadge, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` L ${ssrInterpolate(__props.node.total_left)}`);
                } else {
                  return [
                    createTextVNode(" L " + toDisplayString(__props.node.total_left), 1)
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(_component_UBadge, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` R ${ssrInterpolate(__props.node.total_right)}`);
                } else {
                  return [
                    createTextVNode(" R " + toDisplayString(__props.node.total_right), 1)
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("div", { class: "space-y-1 sm:space-y-2" }, [
                createVNode("div", { class: "flex items-start justify-between gap-2" }, [
                  createVNode("div", { class: "min-w-0" }, [
                    createVNode("p", { class: "truncate text-xs font-semibold text-highlighted sm:text-sm" }, toDisplayString(__props.node.name), 1),
                    createVNode("p", { class: "truncate text-[10px] text-muted sm:text-[11px]" }, "@" + toDisplayString(__props.node.username), 1)
                  ]),
                ...
                createVNode("div", { class: "flex flex-wrap gap-0.5 sm:gap-1" }, [
                  createVNode(_component_UBadge, {
                    color: "neutral",
                    variant: "subtle",
                    size: "xs",
      ...
      if (showChildren.value) {
        _push(`<div class="mt-3 w-full sm:mt-4"><div class="mx-auto h-3 w-px bg-gray-300 dark:bg-gray-700 sm:h-4"></div><div class="relative grid grid-cols-2 gap-1 px-0.5 sm:gap-6 sm:px-2"><div class="absolute left-[29%] right-[29%] top-0 h-px bg-gray-300 dark:bg-gray-700 sm:left-[27%] sm:right-[27%]"></div><div class="relative flex justify-center pt-3 sm:pt-4"><div class="absolute left-[58%] top-0 h-3 w-px -translate-x-1/2 bg-gray-300 dark:bg-gray-700 sm:left-[55%] sm:h-4"></div>`);
        if (__props.node.left) {
          ...
          _push(ssrRenderComponent(_component_UCard, { class: "w-36 rounded-xl border border-dashed border-default bg-elevated/40 sm:w-52 sm:rounded-2xl lg:w-55" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="flex flex-col items-center gap-1.5 py-1.5 text-center sm:gap-2 sm:py-2"${_scopeId}>`);
                _push2(ssrRenderComponent(_component_UIcon, {
                  name: "i-lucide-user-round-plus",
                  class: "size-4 text-muted sm:size-5"
                }, null, _parent2, _scopeId));
                _push2(`<p class="text-[11px] text-muted sm:text-xs"${_scopeId}>Slot kiri kosong</p>`);
                _push2(ssrRenderComponent(_component_UButton, {
                  size: "xs",
                  color: "primary",
                  variant: "soft",
                ...
                return [
                  createVNode("div", { class: "flex flex-col items-center gap-1.5 py-1.5 text-center sm:gap-2 sm:py-2" }, [
                    createVNode(_component_UIcon, {
                      name: "i-lucide-user-round-plus",
                      class: "size-4 text-muted sm:size-5"
                    }),
                    createVNode("p", { class: "text-[11px] text-muted sm:text-xs" }, "Slot kiri kosong"),
                    createVNode(_component_UButton, {
                      size: "xs",
                      color: "primary",
                      variant: "soft",
        ...
        _push(`</div><div class="relative flex justify-center pt-3 sm:pt-4"><div class="absolute left-[42%] top-0 h-3 w-px -translate-x-1/2 bg-gray-300 dark:bg-gray-700 sm:left-[45%] sm:h-4"></div>`);
          ...
          _push(ssrRenderComponent(_component_UCard, { class: "w-36 rounded-xl border border-dashed border-default bg-elevated/40 sm:w-52 sm:rounded-2xl lg:w-55" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                _push2(`<p class="text-[11px] text-muted sm:text-xs"${_scopeId}>Slot kanan kosong</p>`);
                _push2(ssrRenderComponent(_component_UButton, {
                  size: "xs",
                  color: "primary",
                  variant: "soft",
                ...
                return [
                  createVNode("div", { class: "flex flex-col items-center gap-1.5 py-1.5 text-center sm:gap-2 sm:py-2" }, [
                    ...
                    createVNode("p", { class: "text-[11px] text-muted sm:text-xs" }, "Slot kanan kosong"),
                    createVNode(_component_UButton, {
                      size: "xs",
                      color: "primary",
                      variant: "soft",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    function centerTreeHorizontally() {
    ...
    function syncCenterOnNextFrame() {
      void nextTick(() => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "rounded-2xl border border-default bg-elevated/20" }, _attrs))}><div class="overflow-x-auto"><div class="min-w-full w-max">`);
      if (__props.currentTree) {
        _push(`<div class="mx-auto w-fit px-2 py-3 transition-transform duration-200 sm:px-4 sm:py-5" style="${ssrRenderStyle({ transform: `scale(${__props.zoom})`, transformOrigin: "top center" })}">`);
