...
import { u as useDashboard } from "./useDashboard-qf5ryXUX.js";
...
const withdrawalStepAmount = 1e3;
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UFormField, {
              ...
              required: "",
              help: `Minimal ${formattedMinimumRequestAmount.value} • Maksimal ${formattedMaxAmount.value} • Kelipatan Rp 1.000`
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UInput, {
            ...
            _push2(`<div class="rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 dark:border-amber-900/40 dark:bg-amber-950/30"${_scopeId}><p class="text-xs font-semibold text-amber-800 dark:text-amber-200"${_scopeId}> Aturan withdrawal </p><p class="mt-1 text-xs text-amber-700 dark:text-amber-300"${_scopeId}> Setiap transaksi withdrawal dikenakan biaya admin ${ssrInterpolate(formattedAdminFee.value)}. </p></div>`);
            _push2(ssrRenderComponent(_component_UFormField, {
              label: "Password akun",
              required: "",
            ...
            return [
              createVNode("div", { class: "space-y-4" }, [
                ...
                createVNode("div", { class: "rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 dark:border-amber-900/40 dark:bg-amber-950/30" }, [
                  createVNode("p", { class: "text-xs font-semibold text-amber-800 dark:text-amber-200" }, " Aturan withdrawal "),
                  createVNode("p", { class: "mt-1 text-xs text-amber-700 dark:text-amber-300" }, " Setiap transaksi withdrawal dikenakan biaya admin " + toDisplayString(formattedAdminFee.value) + ". ", 1)
                ]),
                createVNode(_component_UFormField, {
                  label: "Password akun",
                  required: "",
...
function useDashboardWallet(options) {
  ...
  const withdrawalStepAmount2 = 1e3;
